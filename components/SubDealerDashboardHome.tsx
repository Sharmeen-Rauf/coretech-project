        ...
        <div className="bg-white border border-slate-200 rounded-[10px] p-5 shadow-sm flex flex-col justify-between">
          ...
          <div className="space-y-2 text-xs divide-y divide-slate-100">
            <div className="pt-2 flex justify-between font-medium">
              <span className="text-slate-600 font-bold">New York</span>
              <span className="text-slate-800 font-extrabold">72K</span>
            </div>
            <div className="pt-2 flex justify-between font-medium">
              <span className="text-slate-600 font-bold">San Francisco</span>
              <span className="text-slate-800 font-extrabold">39K</span>
            </div>
            <div className="pt-2 flex justify-between font-medium">
              <span className="text-slate-600 font-bold">Sydney</span>
              <span className="text-slate-800 font-extrabold">25K</span>
            </div>
            <div className="pt-2 flex justify-between font-medium">
              <span className="text-slate-600 font-bold">Singapore</span>
              <span className="text-slate-800 font-extrabold">61K</span>
            </div>
          </div>
        </div>
      </div>
