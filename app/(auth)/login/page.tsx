  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (profileError || !profile) {
        // Fallback for demo users if profiles row does not exist yet (helpful for staging/testing)
        toast.success("Logged in successfully (No profile found, defaulting to Admin)");
        router.push("/dashboard");
        return;
      }

      toast.success(`Successfully logged in as ${profile.role}`);
