...
export default function InstallerDeleteAccountPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const subject = "CoreTech Installer — Account Deletion Request";
    const body =
      `Name: ${name.trim()}\n` +
      `Account email: ${email.trim()}\n` +
      (reason.trim() ? `Reason: ${reason.trim()}\n` : "") +
      `\nPlease delete my CoreTech Installer account and associated personal data.`;
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-5 sm:px-8 py-10 lg:py-14">
        ...
        <p className="text-lg text-slate-600 leading-relaxed mb-10 pb-8 border-b border-slate-100 max-w-[62ch]">
          If you have a CoreTech Installer account and want it — and the personal information
          tied to it — removed, you can request that here. This works whether or not you still
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm h-fit">
            ...
            {sent ? (
              <div className="bg-emerald-50 border border-emerald-200 text-emerald-700 rounded-lg px-4 py-3 text-sm leading-relaxed">
                ...
                <span className="font-semibold">info@coretechsolar.pk</span> — review it and hit
                send from there.
              </div>
            ) : (
            ...
            <ol className="space-y-3.5">
              {[
                ...
                },
                {
                  ...
                  d: "and your personal profile information (name, CNIC, address, payment details) is deleted from our systems.",
                },
                {
                  t: "Business records tied to your account",
                  d: "(completed installation jobs, photos/videos submitted as proof of work, and payment history) may be kept as part of CoreTech Solar's own accounting and audit records, as described in the Privacy Policy — this is standard for any business tool, not personal data being retained.",
                },
                {
      ...
      <footer className="border-t border-slate-100">
        <div className="max-w-4xl mx-auto px-5 sm:px-8 py-6 flex flex-wrap justify-between gap-3 text-xs text-slate-400">
          ...
          <span>
            See also{" "}
            <Link href="/privacy/installer" className="text-[#0077B6]">
              Privacy Policy
            </Link>
          </span>
        </div>
