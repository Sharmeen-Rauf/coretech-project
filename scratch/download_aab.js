...
const url = "https://expo.dev/artifacts/eas/3hhEYHsYUaX7U3EUzpFFcluH-qBeo-h-TU5mPX01yX8.aab";
const dest = path.join(__dirname, "..", "coretech-mobile", "build-1.0.0-api35-version4.aab");
